...
public class OtherFollower extends JFrame implements ActionListener {
	static int MyIdx;
	static int userIdx;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OtherFollower window = new OtherFollower();
	...
	public OtherFollower(int userIdx, String userName, String userId, int followerCount,int MyIdx) {
		this.MyIdx = MyIdx;
